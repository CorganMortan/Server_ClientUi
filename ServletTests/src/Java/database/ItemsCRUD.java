...
public class ItemsCRUD {
    ...
    private static  final  String DBurl="jdbc:mysql://localhost/Walleinfo";
    ...
    public ArrayList<PcStatistics> get_interval_items(int val_min,int val_max){
        ArrayList<PcStatistics> items=new ArrayList<PcStatistics>();
        try {
            if(create_connection()==true) {
